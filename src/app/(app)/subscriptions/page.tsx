...
export default function SubscriptionsPage() {
  ...
  const monthly = subsMonthlyTotal(active.map((s) => ({ amount: s.amount, billingCycle: s.billingCycle })));
  const yearly = subsYearlyTotal(active.map((s) => ({ amount: s.amount, billingCycle: s.billingCycle })));
