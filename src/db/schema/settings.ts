...
/**
 * Singleton settings row (id = 'singleton'). Holds user preferences and a few
 * derived-calculation knobs (FY start, default GST, large-payment threshold).
 */
export const settings = pgTable("settings", {
  ...
  largePaymentThreshold: bigint("large_payment_threshold", { mode: "number" }),
